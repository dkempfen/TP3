...
require_once $_SERVER['DOCUMENT_ROOT'] . '/instituto/Adman/subPantallas/lista_usuarios.php';
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ModalsEditarUsuario" name="ModalsEditarUsuario" action="/instituto/Includes/sqluser.php"
                    method="POST">
