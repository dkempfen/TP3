...
foreach ($obtenerFinales as $obtenerFinales) { ?>
<div class="modal fade" id="modaleditarFechaFinal_<?php echo $obtenerFinales['Id_Fecha_Final']; ?>" tabindex="-1"
...
function ModalsFinalEditar(Id_Fecha_Final) {
    ...
    var Id_Fecha_Final = "#modaleditarFechaFinal_" + Id_Fecha_Final;
