<?php
//require_once $_SERVER['DOCUMENT_ROOT'] . '/sistema/instituto/Adman/ModelsPlan/crearPlan.php';
...
require_once $_SERVER['DOCUMENT_ROOT'] . '/sistema/instituto/Adman/modals/modal_EditarPlan.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/sistema/instituto/Adman/modals/modal_carrera.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/sistema/instituto/Adman/modals/modal_CrearPlan.php';
        ...
        <nav class="custom-nav">
            <div class="menu-group">
                <ul class="custom-menu-list">
                    ...
                    <li class="custom-menu-item">
                        <a class="custom-menu-link" href="/sistema/instituto/Adman/Pantallas/carreras.php">Nuestras Carreras</a>
            ...
            <div class="menu-group">
                <ul class="custom-menu-list">
                    <!-- Planes de Estudio -->
                    <li class="custom-menu-item">
                        <a class="custom-menu-link" href="/sistema/instituto/Adman/lista_planes.php">Planes de Estudio</a>
            ...
            <div class="menu-group">
                <ul class="custom-menu-list">
                    <!-- Materias -->
                    <li class="custom-menu-item">
                        <a class="custom-menu-link" href="/sistema/instituto/Adman/lista_materia.php">Materias</a>
        ...
        <div class="row espaciado-entre-plames align-items-center">
            <div class="col-lg-6">
                ...
                <div class="custom-link">
                    <a href="/sistema/instituto/Adman/Pantallas/carreras.php" title="">
