...
require_once $_SERVER['DOCUMENT_ROOT'] . '/sistema/instituto/Adman/modals/modal_materia.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/sistema/instituto/Adman/modals/editar_materia.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/sistema/instituto/Adman/modals/confirmacionCambioProfesor.php';
...
$(document).ready(function() {
    ...
    $('#tablemateria').on("change", ".onoffswitch-checkbox", function() {
        ...
        $.ajax({
            url: "/sistema/instituto/Includes/sqlaltauser.php",
            type: "POST",
            data: {
