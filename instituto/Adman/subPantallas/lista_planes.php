        ...
        <div class="row espaciado-entre-filas">
            <?php
                ...
                foreach ($resultado as $fila) {
                    ...
                    echo '<div class="card">';
                    echo '<input type="hidden" name="cod_Plan"  id="cod_Plan" class="codigo-plan" value="' . $fila['cod_Plan'] . '">';
...
function mostrarInfoAdicional(boton) {
    ...
    // Resto de tu código para mostrar la modal y otros cambios necesarios
    document.getElementById('codPlanMateria').value = "";
    document.querySelector('.modal-header').classList.replace("headerUpdate", "headerRegister");
    document.getElementById('tablaMostrarMateria').innerHTML = 'Información Adicional para el Plan: ' + cod_Plan;
