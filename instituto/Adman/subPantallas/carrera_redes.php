...
<main class="app-content">
    <div class="container">
        ...
        <section class="single-hero" style="background-image: url('https://lujanbuenviaje.edu.ar/sistema/instituto/Imagenes/profiles/portada-redes.jpg');
                background-size: cover;
                background-position: center calc(100% - 60%); /* Movemos la imagen hacia arriba en un 20% de la altura */
                height: 320px;">
            <div class="container-sistemas">
                <div class="row">
                    <div class="col-lg-7 col-sm-7 col-xs-12">
                        <div class="texts">
                            <h1 style="color: white; font-weight: bold; font-size: 36px; margin-top: 100px;">Redes Informaticas</h1>
            ...
            <div class="col-md-6">
                <section class="container program-info" style="background-color: #fff">
                    ...
                    $sql = "SELECT * FROM Materia m INNER JOIN Detalle_Plan dp ON m.id_Materia = dp.fk_Materia
                        WHERE dp.fk_Plan = '5817/03' ORDER BY Anio_Carrera ASC";
