                ...
                <div class="card bg-primary text-white">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <a href="<?php echo '/sistema/instituto/Adman/lista_usuarios.php?rol=3';?>"
                                class="stretched-link"></a>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between">
                        <a href="<?php echo '/sistema/instituto/Adman/lista_usuarios.php?rol=3';?>" class="text-white">Ver
                            detalle</a>
                ...
                <div class="card bg-success text-white">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <a href="<?php echo '/sistema/instituto/Adman/lista_usuarios.php?rol=1';?>"
                                class="stretched-link"></a>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between">
                        <a href="<?php echo '/sistema/instituto/Adman/lista_usuarios.php?rol=1';?>" class="text-white">Ver
                            detalle</a>
                ...
                <div class="card bg-danger text-white">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <a href="<?php echo '/sistema/instituto/Adman/lista_usuarios.php?rol=2';?>"
                                class="stretched-link"></a>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between">
                        <a href="<?php echo '/sistema/instituto/Adman/lista_usuarios.php?rol=2';?>" class="text-white">Ver
                            detalle</a>
                ...
                <div class="card bg-info text-white">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <a href="<?php echo '/sistema/instituto/Adman/lista_usuarios.php';?>" class="stretched-link"></a>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between">
