...
function showConfirmationMessageUser($message, $rolUserEditar) {
    ...
    if ($rolUserEditar == 3) {
        echo "window.location.href = '/sistema/instituto/Adman/lista_usuarios.php?rol=3';";
    } elseif ($rolUserEditar == 2) {
        echo "window.location.href = '/sistema/instituto/Adman/lista_usuarios.php?rol=2';";
    } elseif ($rolUserEditar == 1) {
        echo "window.location.href = '/sistema/instituto/Adman/lista_usuarios.php?rol=1';";
    } else {
        echo "window.location.href = '/sistema/instituto/Adman/lista_usuarios.php';";
    }
...
function showConfirmationMessagePlan($messagePlan) {
    echo "<script>
        Swal.fire({
            ...
            window.location.href = '/sistema/instituto/Adman/lista_planes.php';
...
function editarUsuarios($legajoUser, $claveeditaruser, $libromatrizEditar, $planUserEditar, $rolUserEditar, $UserId) {
    ...
    if ($rolUserEditar == 3) {
        header("Location:/sistema/instituto/Adman/lista_usuarios.php?rol=3");
    } elseif ($rolUserEditar == 2) {
        header("Location:/sistema/instituto/Adman/lista_usuarios.php?rol=2");
    } elseif ($rolUserEditar == 1) {
        header("Location:/sistema/instituto/Adman/lista_usuarios.php?rol=1");
    } else {
        header("Location:/sistema/instituto/Adman/lista_usuarios.php");
    }
    exit();
}
...
function guardarCambios($nombreTarjeta, $estadoTarjeta, $fechaInicio, $fechaFinal, $cod_Plan) {
    ...
    header("Location:/sistema/instituto/Adman/lista_planes.php");
    exit();
}
