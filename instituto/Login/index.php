    ...
    <header class="main-header">
        <div class="main-cont">
            <div class="desc-header">
                <img src="/sistema/instituto/Imagenes/lOGO.gif" alt="image instituto">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <form action="" method='post' onsubmit="return validar()">
                        ...
                        <button class="clave" type="button" onclick="location.href='/sistema/instituto/Login/RecuperoClave.php'">
                ...
                <div class="text-center">
                    ...
                    <a class="buttons button-large button-rounded botonfooter" id=""
                        href="/sistema/instituto/Login/registro.php">Inscripción</a>
                </div>
            </div>
        </div>
    </header>
