                    ...
                    <form class="form-inline" role="form">
                        ...
                        <div class="form-btn">
                            ...
                            <input type="button" name="volver" value="Volver" class="bvolver"
                                onclick="window.location.href='/sistema/instituto/Login/index.php'">
                        </div>
...
<script src="/sistema/instituto/js/jquery-3.3.1.min.js"></script>
<script src="/sistema/instituto/js/plugins/login.js"></script>
